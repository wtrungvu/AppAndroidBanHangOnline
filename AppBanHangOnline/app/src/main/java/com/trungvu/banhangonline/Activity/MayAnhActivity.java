...
import com.trungvu.banhangonline.Adapter.MayAnhAdapter;
...
public class MayAnhActivity extends AppCompatActivity {

    Toolbar toolbarMayAnh;

    ArrayList<SanPham> mangMayAnh;
    MayAnhAdapter adapterMayAnh;
    ListView listViewMayAnh;
    ...
    private void addControls() {
        ...
        mangMayAnh = new ArrayList<>();

        adapterMayAnh = new MayAnhAdapter(
                getApplicationContext(), mangMayAnh
        );

        listViewMayAnh = findViewById(R.id.listViewMayAnh);
        listViewMayAnh.setAdapter(adapterMayAnh);
    ...
    private void loadMoreData() {
        listViewMayAnh.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        listViewMayAnh.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("ThongTinSanPham", mangMayAnh.get(i));
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            listViewMayAnh.removeFooterView(footerView);
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangMayAnh.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
                                    adapterMayAnh.notifyDataSetChanged();
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maMayAnh));
                return param;
            }
        };
    ...
    private void ActionToolBar() {
        ...
        toolbarMayAnh.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getMaLoaiSanPham() {
        maMayAnh = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maMayAnh + "");
    }
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    listViewMayAnh.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
