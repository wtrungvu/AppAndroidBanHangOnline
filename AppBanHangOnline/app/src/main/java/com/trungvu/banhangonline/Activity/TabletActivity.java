...
import com.trungvu.banhangonline.Adapter.TabletAdapter;
...
public class TabletActivity extends AppCompatActivity {
    ...
    ArrayList<SanPham> mangTablet;
    TabletAdapter adapterTablet;
    ...
    private void addControls() {
        ...
        mangTablet = new ArrayList<>();

        adapterTablet = new TabletAdapter(
                getApplicationContext(),
                mangTablet
        );

        listViewTablet = findViewById(R.id.listViewTablet);
        listViewTablet.setAdapter(adapterTablet);
    ...
    private void loadMoreData() {
        ...
        listViewTablet.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("ThongTinSanPham", mangTablet.get(i));
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangTablet.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maTablet));
                return param;
            }
        };
    ...
    private void getMaLoaiSanPham() {
        maTablet = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maTablet + "");
    }
