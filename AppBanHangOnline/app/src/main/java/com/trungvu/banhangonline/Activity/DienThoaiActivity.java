...
public class DienThoaiActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        adapterDienThoai = new DienThoaiAdapter(
                getApplicationContext(), mangDienThoai
        );
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangDienThoai.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maDienThoai));
                return param;
            }
        };
    ...
    private void getMaLoaiSanPham() {
        maDienThoai = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maDienThoai + "");
    }
