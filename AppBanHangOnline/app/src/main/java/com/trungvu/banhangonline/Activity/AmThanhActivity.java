...
import com.trungvu.banhangonline.Adapter.AmThanhAdapter;
...
public class AmThanhActivity extends AppCompatActivity {

    Toolbar toolbarAmThanh;

    ArrayList<SanPham> mangAmThanh;
    AmThanhAdapter adapterAmThanh;
    ListView listViewAmThanh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_am_thanh);
    ...
    private void addControls() {
        toolbarAmThanh = findViewById(R.id.toolBarAmThanh);

        mangAmThanh = new ArrayList<>();

        adapterAmThanh = new AmThanhAdapter(
                getApplicationContext(), mangAmThanh
        );

        listViewAmThanh = findViewById(R.id.listViewAmThanh);
        listViewAmThanh.setAdapter(adapterAmThanh);
    ...
    private void loadMoreData() {
        listViewAmThanh.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        listViewAmThanh.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("ThongTinSanPham", mangAmThanh.get(i));
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            listViewAmThanh.removeFooterView(footerView);
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangAmThanh.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
                                    adapterAmThanh.notifyDataSetChanged();
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maAmThanh));
                return param;
            }
        };
    ...
    private void ActionToolBar() {
        setSupportActionBar(toolbarAmThanh);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); // set button back in toolbar

        toolbarAmThanh.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getMaLoaiSanPham() {
        maAmThanh = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maAmThanh + "");
    }
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    listViewAmThanh.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
