...
import com.trungvu.banhangonline.Adapter.ThietBiDeoThongMinhAdapter;
...
public class ThietBiDeoThongMinhActivity extends AppCompatActivity {

    Toolbar toolbarThietBiDeoThongMinh;

    ArrayList<SanPham> mangThietBiDeoThongMinh;
    ThietBiDeoThongMinhAdapter adapterThietBiDeoThongMinh;
    ListView listViewThietBiDeoThongMinh;

    int maThietBiDeoThongMinh = 0;
    int page = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thiet_bi_deo_thong_minh);
    ...
    private void addControls() {
        toolbarThietBiDeoThongMinh = findViewById(R.id.toolBarThietBiDeoThongMinh);

        mangThietBiDeoThongMinh = new ArrayList<>();

        adapterThietBiDeoThongMinh = new ThietBiDeoThongMinhAdapter(
                getApplicationContext(), mangThietBiDeoThongMinh
        );

        listViewThietBiDeoThongMinh = findViewById(R.id.listViewThietBiDeoThongMinh);
        listViewThietBiDeoThongMinh.setAdapter(adapterThietBiDeoThongMinh);
    ...
    private void loadMoreData() {
        listViewThietBiDeoThongMinh.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        listViewThietBiDeoThongMinh.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(), ChiTietSanPhamActivity.class);
                intent.putExtra("ThongTinSanPham", mangThietBiDeoThongMinh.get(i));
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            listViewThietBiDeoThongMinh.removeFooterView(footerView);
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangThietBiDeoThongMinh.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
                                    adapterThietBiDeoThongMinh.notifyDataSetChanged();
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maThietBiDeoThongMinh));
                return param;
            }
        };
    ...
    // Tao nút back trên thanh ToolBar
    private void ActionToolBar() {
        setSupportActionBar(toolbarThietBiDeoThongMinh);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); // set button back in toolbar

        toolbarThietBiDeoThongMinh.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getMaLoaiSanPham() {
        maThietBiDeoThongMinh = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maThietBiDeoThongMinh + "");
    }
    ...
    public class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    listViewThietBiDeoThongMinh.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
