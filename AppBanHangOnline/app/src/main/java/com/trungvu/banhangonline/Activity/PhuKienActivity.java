...
import com.trungvu.banhangonline.Adapter.PhuKienAdapter;
...
public class PhuKienActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        adapterPhuKien = new PhuKienAdapter(
                getApplicationContext(), mangPhuKien
        );

        listViewPhuKien = findViewById(R.id.listViewPhuKien);
        listViewPhuKien.setAdapter(adapterPhuKien);
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangPhuKien.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
                                    adapterPhuKien.notifyDataSetChanged();
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maPhuKien));
                return param;
            }
        };
    ...
    private void getMaLoaiSanPham() {
        maPhuKien = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maPhuKien + "");
    }
