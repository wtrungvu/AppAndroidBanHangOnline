...
import com.trungvu.banhangonline.Adapter.DienThoaiAdapter;
import com.trungvu.banhangonline.Adapter.LaptopAdapter;
...
public class LaptopActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        adapterLaptop = new LaptopAdapter(
                getApplicationContext(), mangLaptop
        );
    ...
    private void getData(int Page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanSP,
                        ...
                        if (response != null && response.length() != 2)
                        {
                            ...
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    mangLaptop.add(new SanPham(maSP, maLoaiSP, maThuongHieuSP, tenSP, giaSP, hinhSP, thongSoKiThuatSP, dacDiemNoiBatSP, phuKienTrongHopSP, thangBaoHanhSP));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("MaSanPham", String.valueOf(maLaptop));
                return param;
            }
        };
    ...
    private void getMaLoaiSanPham() {
        maLaptop = getIntent().getIntExtra("MaLoaiSanPham", -1);
        Log.d("GiaTriLoaiSanPham = ", maLaptop + "");
    }
